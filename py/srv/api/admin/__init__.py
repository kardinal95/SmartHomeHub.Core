...
from py.srv.api.admin.resources.rooms import Rooms, RoomDevices
...
def add_resources(api):
    ...
    api.add_resource(Rooms, '/api/admin/rooms')
    api.add_resource(RoomDevices, '/api/admin/rooms/<string:room_uuid>/devices')
